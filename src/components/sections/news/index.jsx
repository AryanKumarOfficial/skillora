...
const News = () => {
    return (
        <section className="lg:pt-15 lg:pb-15 pt-10 pb-10 bg-gradient-to-b from-warm via-cream-foreground to-warm">
            <div className="container">
                ...
                <div className="lg:pt-15 pt-10">
                    <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-7.5">
                        {newsData.slice(0, 3).map(({id, title, description, src, date, type}) => (
                            <TeamCard
                                key={id}
                                name={title}
