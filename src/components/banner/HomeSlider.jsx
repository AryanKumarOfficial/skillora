...
import sliderImg11 from "/public/images/slider/11.jpg";
import sliderImg12 from "/public/images/slider/12.jpg";
                    ...
                    <Slider {...sliderSettings}>
                        <div className="single-slide">
                            <div className="slider-img">
                                <img className="desktop" src={"/images/slider/1.jpg"}/>
                                <img className="mobile" src={"/images/slider/1.jpg"} alt="Slider Image 1"/>
                            </div>
                                ...
                                <div className="slider-content">
                                    <div className="content-part">
                                        ...
                                        <div className="slider-btn wow animate__fadeInUp" data-wow-duration="1.2s">
                                            <Link href="/about" className="react-btn-border">Admissions</Link>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="single-slide">
                            <div className="slider-img">
                                <img className="desktop" src={"/images/slider/1.jpg"} alt="Slider Image 1"/>
                                <img className="mobile" src={"/images/slider/1.jpg"} alt="Slider Image 1"/>
                            </div>
                            <div className="container">
                                <div className="slider-content">
