...
const CurricularGrid = () => {
    ...
    const sortedSchoolActivities = [...filteredSchoolActivities].sort((a, b) => {
    ...
    const totalPages = Math.ceil(sortedSchoolActivities.length / ITEMS_PER_PAGE);
    const paginatedSchoolActivities = sortedSchoolActivities.slice((currentPage - 1) * ITEMS_PER_PAGE, currentPage * ITEMS_PER_PAGE);
            ...
            <div className="container">
                <div className="lg:pl-11">
                    ...
                    <div className="grid md:grid-cols-4 grid-cols-1 gap-y-7.5 lg:gap-x-[45px] gap-x-5 lg:pt-15 pt-10">
                        {paginatedSchoolActivities.map(({ id, title, description, date, image, category }) => (
                            <CardTwo
                                key={id}
                                id={id}
                                src={image}
